...
Using `style=for-the-badge` instead of `flat` gives a larger, more prominent variant. The raw SVG icon lives at [docs/assets/hawk-icon.svg](docs/assets/hawk-icon.svg).
